...
*/
        ...
        transaksi.forEach(element -> tl.addRow(String.valueOf(element.tanggalTransaksi), element.judulBuku, String.valueOf(element.qtyBuku), String.valueOf(element.totalHarga)));
        tl.print();
    }
